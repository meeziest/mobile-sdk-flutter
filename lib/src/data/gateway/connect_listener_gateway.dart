...
class ConnectListenerGateway {
  ...
  void listenToConnectivityChanges() async {
    Connectivity()
        .onConnectivityChanged
        .listen((List<ConnectivityResult> result) {
      if (result.first != connectivityResult) {
        log.info('Connectivity changed from $connectivityResult to $result');
        connectivityResult = result.first;
        handleStreamCleanup();
        log.warning('Response stream canceled due to connectivity changes');
      } else {
        return;
      }
    });
  ...
  Future<void> checkInitialConnectivity() async {
    ...
    connectivityResult = connectivityList.first;
